...
function wsOpen() {
	...
	//ws = new WebSocket("ws://192.168.0.71:8080/chatting");
...
function fileSend() {
	...
	fileReader.onload = function() {
		...
		ws.send(JSON.stringify(param)); // sessionId를 담기 위해
...
$('#fileImg').click(function() { // 파일선택 input 숨기기
	$('#fileUpload').click();
})

$('#fileUpload').change(function() { // 파일선택 input 숨기기
	fileSend();
})

$(document).ready(function() { // 빈값 체크
	$('#sendBtn').attr('disabled', 'disabled');
